...
# el merge se hace en la rama main
    ...
    # 0 verificar cambios en la ramas
    # 1. Actualizar tu main local
     git checkout main
     git pull origin main

    # 2. Traer todas las ramas remotas
     git fetch origin

    # 3. Ahora haz merge de la rama remota completa una por una
        # Merge de Lizarzaburu
        git merge origin/Lizarzaburu/models
        git add .
        git commit -m "Subiendo la rama Lizarzaburu/models"

        # Merge de Escobedo
        git merge origin/Escobedo/services
        git add .
        git commit -m "Subiendo la rama Escobedo/services "

        # Merge de Mallma
        git merge origin/Mallma/utils
        git add .
        git commit -m "Subiendo la rama Mallma/utils"

        # Merge de Pascacio
        git merge origin/Pascacio/repositories
        git add .
        git commit -m "Subiendo la rama Pascacio/repositories "

        # Merge de Tantavilca
        git merge origin/Tantavilca/tests
        git add .
        git commit -m "Subiendo la rama Tantavilca/tests"
